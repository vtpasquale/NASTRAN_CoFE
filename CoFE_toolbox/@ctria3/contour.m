...
switch fopts.contourType
    ...
    case 'Displacements'
        switch fopts.contourTypeSpecificOpt
            case 'Magnitude'
                contourValues = ...
                    [norm_cs(def(:,1)), norm_cs(def(:,2)), norm_cs(def(:,3)), norm_cs(def(:,3))];
            case 'X Component'
                contourValues = ...
                    [def(1,1), def(1,2), def(1,3), def(1,3)];
            case 'Y Component'
                contourValues = ...
                    [def(2,1), def(2,2), def(2,3), def(2,3)];
            case 'Z Component'
                contourValues = ...
                    [def(3,1), def(3,2), def(3,3), def(3,3)];
        end
    case 'Rotations'
        ...
        if isempty(allDef);
            ...
            r = allDef([obj.gdof(4:6),obj.gdof(10:12),obj.gdof(16:18),obj.gdof(16:18)]);
        end
        switch fopts.contourTypeSpecificOpt
            case 'Magnitude'
                contourValues = ...
                    [norm_cs(r(:,1)), norm_cs(r(:,2)), norm_cs(r(:,3)), norm_cs(r(:,3))];
            case 'X Component'
                contourValues = ...
                    [r(1,1), r(1,2), r(1,3), r(1,3)];
            case 'Y Component'
                contourValues = ...
                    [r(2,1), r(2,2), r(2,3), r(2,3)];
            case 'Z Component'
                contourValues = ...
                    [r(3,1), r(3,2), r(3,3), r(3,3)];
        end
    case 'Stress'
        switch fopts.contourTypeSpecificOpt
            case 'von Mises'
            ...
            case 'X Component'
                ...
                contourValues = [vs(1,1,1) vs(1,1,2) vs(1,1,3) vs(1,1,3)];
            case 'Y Component'
