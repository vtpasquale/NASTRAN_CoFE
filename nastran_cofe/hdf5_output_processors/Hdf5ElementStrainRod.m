%Hdf5ElementStrainRod HDF5 data class for CROD strain data.
...
classdef Hdf5ElementStrainRod < Hdf5ElementStrain
    
    properties
        EID % [uint32] Element identification number
        A % [double] Axial strain
        MSA % [double] Axial Safety Margin
        T % [double] Torsion? strain
    ...
    methods
        function obj = Hdf5ElementStrainRod(arg1,arg2)
            if nargin > 0
                if ischar(arg1)
