%Hdf5ElementStressBar HDF5 data class for BAR element stress data.
...
classdef Hdf5ElementStressBar < Hdf5ElementStress
    ...
    methods
        function obj = Hdf5ElementStressBar(arg1,arg2)
            if nargin > 0
                if ischar(arg1)
