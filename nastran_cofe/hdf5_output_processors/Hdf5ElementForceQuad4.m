%Hdf5ElementForceQuad4 HDF5 data class for QUAD4 force data.
...
classdef Hdf5ElementForceQuad4 < Hdf5ElementForce
    ...
    methods
        function obj = Hdf5ElementForceQuad4(arg1,arg2)
            if nargin > 0
                if ischar(arg1)
