%Hdf5ElementStressBeam HDF5 data class for CBEAM stress data.
...
% <typedef name="BEAM_SS" description="Stress and stress structure for BEAM">
...
% <field name="XC" type="double" description="Longitudonal Stress or Stress at Point C"/>
% <field name="XD" type="double" description="Longitudonal Stress or Stress at Point D"/>
% <field name="XE" type="double" description="Longitudonal Stress or Stress at Point E"/>
% <field name="XF" type="double" description="Longitudonal Stress or Stress at Point F"/>
% <field name="MAX" type="double" description="Maximal Stress or Stress"/>
% <field name="MIN" type="double" description="Minimal Stress or Stress"/>
...
classdef Hdf5ElementStressBeam < Hdf5ElementStress
    ...
    properties
        ...
        XC % [11,n double] Longitudonal Stress or Stress at Point C
        XD % [11,n double] Longitudonal Stress or Stress at Point D
        XE % [11,n double] Longitudonal Stress or Stress at Point E
        XF % [11,n double] Longitudonal Stress or Stress at Point F
        MAX % [11,n double] Maximal Stress or Stress
        MIN % [11,n double] Minimal Stress or Stress
    ...
    methods
        function obj = Hdf5ElementStressBeam(arg1,arg2)
            if nargin > 0
                if ischar(arg1)
