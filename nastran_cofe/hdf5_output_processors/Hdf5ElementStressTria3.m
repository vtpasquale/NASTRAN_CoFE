%Hdf5ElementStressBeam HDF5 data class for TRAI3 stress data.
...
classdef Hdf5ElementStressTria3 < Hdf5ElementStress
    ...
    methods
        function obj = Hdf5ElementStressTria3(arg1,arg2)
            if nargin > 0
                if ischar(arg1)
